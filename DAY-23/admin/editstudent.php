<?php 
	include'../config.php';
      ...
      //session_start();
// name,ftname,mtname,class,phone,studentimage,address
...
date_default_timezone_set('ASIA/KOLKATA');
	...
	echo	$updated_at=date('Y-m-d H:i:s');
       ...
       if(empty($fname)){
			$qry="UPDATE student SET stu_name='$name',fathername='$fathername',mothername='$mothername',class='$class',phone='$phno',updated_at='$updated_at' WHERE stu_id='$edit' ";
		}
		else{
			$tmp_name=$studentimage['tmp_name'];
			$path="../images/".$fname;
			move_uploaded_file($tmp_name, $path);
			$qry="UPDATE student SET stu_name='$name',fathername='$fathername',mothername='$mothername',class='$class',image='$fname',phone='$phno',address='$address',updated_at='$updated_at' WHERE stu_id='$edit' ";
		}
